...
public class PermissionManager {
    ...
    public static boolean checkPermission(String permission, CommandSender cs) {
	if (cs instanceof Player) {
	    return checkPermission(permission, (Player) cs);
	} else {
	    return true;
	}
    }
	...
	// loop through the channels in the channel manager and check force
	// listen perms
