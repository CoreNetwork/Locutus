...
public class UntimeoutCommand extends AbstractChatCommand {

    public UntimeoutCommand() {
	super("untimeout", "Untimeout a player", "None", false, "untimeout", new String[0]);
    }
	...
	if (targetPlayers.isEmpty()) {
		...
		DatabaseManager.updateQuery("UPDATE chat_Modes set modeStatus=0 WHERE upper(playerName) = upper(?) AND  modeName= ?", "MUTE");
