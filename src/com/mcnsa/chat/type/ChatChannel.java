...
public class ChatChannel implements Serializable {
    ...
    public ChatChannel(String cname, String wperm, String rperm, String alias, ChatColor colour) {
	this.name = cname;
	...
	if (this.color == null)
	    ...
	    out.writeUTF(this.color.toString());
	...
	if (color.equals("null"))
	    color = null;
	ChatChannel c = new ChatChannel(name, writePerm, readPerm, alias, ChatColor.valueOf(color));
	c.modes = modes;
