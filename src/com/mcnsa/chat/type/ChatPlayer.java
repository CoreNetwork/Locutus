...
public class ChatPlayer implements Serializable{
	...
	public void savePlayer() {
			try {
				...
				for(UUID id : muted)
				{
					DatabaseManager.updateQuery("INSERT INTO chat_MutedPlayers VALUES(?,?)", this.name, id.toString());
				}
	...
	public int channelListen(String channel){
		...
		else if (ChannelManager.getChannel(channel) != null && !PermissionManager.checkPermission(ChannelManager.getChannel(channel).readPermission, name)){
			return 2;
		}
		else {
